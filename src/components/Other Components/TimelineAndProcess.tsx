            ...
            <div>
                ...
                <div className="grid grid-cols-8 h-[400px]">
                    <div className="relative border-l-2 border-[#e6e6e6] h-full border-dashed grid grid-rows-8 ">
                        <div className="group relative row-start-2 bg-[#f4f4f4] p-3 z-10 cursor-pointer before:content-[''] before:absolute before:inline-block before:w-[4px] before:h-[70%] before:left-1 before:top-2 before:bg-primary before:py-2 before:rounded-md hover:before:w-[93%] before:duration-200 hover:text-secondary">
                            <span className="relative z-20">Consultation</span>
                            <section className="absolute left-0 top-16 w-[190%] text-[13px] bg-primary p-3 text-white scale-x-0 duration-200 origin-left group-hover:scale-100">
                    ...
                    <div className="border-l-2 border-[#e6e6e6] h-full border-dashed grid grid-rows-8">
                        <div className="group relative row-start-3 bg-[#f4f4f4] p-3 z-10 cursor-pointer before:content-[''] before:absolute before:inline-block before:w-[4px] before:h-[70%] before:left-1 before:top-2 before:bg-primary before:py-2 before:rounded-md hover:before:w-[93%] before:duration-200 hover:text-secondary">
                    ...
                    <div className="border-l-2 border-[#e6e6e6] h-full border-dashed"></div>
                    <div className="border-l-2 border-[#e6e6e6] h-full border-dashed grid grid-rows-8">
                        <div className="group relative row-start-4 bg-[#f4f4f4] p-3 z-10 cursor-pointer before:content-[''] before:absolute before:inline-block before:w-[4px] before:h-[70%] before:left-1 before:top-2 before:bg-primary before:py-2 before:rounded-md hover:before:w-[93%] before:duration-200 hover:text-secondary">
                    ...
                    <div className="border-l-2 border-[#e6e6e6] h-full border-dashed"></div>
                    <div className="border-l-2 border-[#e6e6e6] h-full border-dashed grid grid-rows-8">
                        <div className="group relative row-start-5 bg-[#f4f4f4] p-3 z-10 cursor-pointer before:content-[''] before:absolute before:inline-block before:w-[4px] before:h-[70%] before:left-1 before:top-2 before:bg-primary before:py-2 before:rounded-md hover:before:w-[93%] before:duration-200 hover:text-secondary">
